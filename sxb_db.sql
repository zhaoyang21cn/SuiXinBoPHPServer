...
--
-- Host: 127.0.0.1
-- Generation Time: 2016-05-23 06:35:09
-- 服务器版本： 5.6.17
-- PHP Version: 5.5.12
...
CREATE TABLE IF NOT EXISTS `t_live_record` (
  ...
  `address` double NOT NULL COMMENT '地址',
...
) ENGINE=InnoDB  DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='直播记录表' AUTO_INCREMENT=12345 ;

-- --------------------------------------------------------

--
-- 表的结构 `t_user_chat_room`
--

CREATE TABLE IF NOT EXISTS `t_user_chat_room` (
